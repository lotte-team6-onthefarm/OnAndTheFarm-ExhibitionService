package team6.onandthefarmexhibitionservice.config;
...
import team6.onandthefarmexhibitionservice.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/api/user/data-call/**", "/api/user/exhibition/all").permitAll()
